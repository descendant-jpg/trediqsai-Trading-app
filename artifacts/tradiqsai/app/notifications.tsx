...
const ITEMS: NotificationItem[] = [
  ...
  { id: '2', category: 'News', asset: 'USD', title: 'US Unemployment Falls', body: 'Fresh labor data is supporting the dollar and may increase volatility through the New York session.', timestamp: '18m ago', tags: ['EUR/USD', '• NEWS'], tone: 'bullish', unread: true },
...
export default function NotificationsScreen() {
  ...
  const unreadCount = ITEMS.filter((item) => item.unread && !read.includes(item.id)).length;
