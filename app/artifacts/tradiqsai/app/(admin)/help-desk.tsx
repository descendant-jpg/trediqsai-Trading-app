...
export default function HelpDeskScreen() {
  ...
  return <SafeAreaView style={styles.safeArea}><View style={styles.header}>
    ...
    <Text style={styles.title}>Support Tickets</Text><View style={styles.spacer} />
  </View><View style={styles.content}><Feather name="life-buoy" size={28} color="#00F0FF" /><Text style={styles.heading}>Support requests in one place</Text><Text style={styles.copy}>Support tickets will appear here.</Text></View></SafeAreaView>;
}
