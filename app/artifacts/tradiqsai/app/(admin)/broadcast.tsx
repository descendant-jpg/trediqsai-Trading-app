...
export default function BroadcastScreen() {
  ...
  return <SafeAreaView style={styles.safeArea}><View style={styles.header}>
    ...
    <Text style={styles.title}>Broadcast Signal</Text><View style={styles.spacer} />
  </View><View style={styles.content}><Feather name="radio" size={28} color="#00F0FF" /><Text style={styles.heading}>Send a market broadcast</Text><Text style={styles.copy}>Signal broadcasting controls will appear here.</Text></View></SafeAreaView>;
}
