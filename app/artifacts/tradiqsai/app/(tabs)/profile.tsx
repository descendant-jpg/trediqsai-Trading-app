  ...
  return (
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.toolsGrid}><Tool icon="cpu" label="AutoPilot Bots" onPress={() => router.push('/profile/autopilot')} /><Tool icon="link" label="BrokerSync" onPress={() => router.push('/profile/brokersync')} /><Tool icon="gift" label="Refer & Earn" badge="+$0.50" onPress={() => router.push('/refer-and-earn' as never)} /><Tool icon="star" label="Manage Plan" gold onPress={() => router.push('/signals')} /></View>
