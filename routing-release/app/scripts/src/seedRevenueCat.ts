...
const PROJECT_NAME = "TradiQs AI";

const PRODUCT_IDENTIFIER = "tradiqs_pro_monthly";
const PLAY_STORE_PRODUCT_IDENTIFIER = "tradiqs_pro_monthly:monthly";

const PRODUCT_DISPLAY_NAME = "TradiQs AI Pro Monthly";
const PRODUCT_USER_FACING_TITLE = "TradiQs AI Pro";
const PRODUCT_DURATION = "P1M";

const APP_STORE_APP_NAME = "TradiQs AI iOS";
const APP_STORE_BUNDLE_ID = "com.tradiqsai.app";
const PLAY_STORE_APP_NAME = "TradiQs AI Android";
const PLAY_STORE_PACKAGE_NAME = "com.tradiqsai.app";
...
async function seedRevenueCat() {
  ...
  if (listAppsError || !apps || apps.items.length === 0) {
    throw new Error("No apps found: " + JSON.stringify(listAppsError));
  }
