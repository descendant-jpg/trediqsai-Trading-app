...
interface AuthContextValue {
  ...
  configured: boolean;
  /** Preferred mode for the signed-out authentication screen. */
  ...
  /** Makes the signed-out screen open directly in account-creation mode. */
  startAccountCreation: () => Promise<void>;
