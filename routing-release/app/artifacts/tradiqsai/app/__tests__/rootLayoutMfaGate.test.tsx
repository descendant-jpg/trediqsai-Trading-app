...
/**
 * Integration test: verifies that MfaGate is mounted inside RootLayout
 * using a dedicated single-component spy — the same vi.fn pattern used for
 * BiometricLock in rootLayoutBiometricLockGate.test.tsx.
 *
 * This catches regressions where <MfaGate /> is silently removed from
...
/**
 * MfaGate: record the call via the spy but still render children so the
...
describe('RootLayout — MfaGate mount guard', () => {
